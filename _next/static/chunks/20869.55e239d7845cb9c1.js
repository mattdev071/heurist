...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [20869],
  {
    55031: function (e, t, s) {
      ...
      let P = "https://explorer-api.walletconnect.com",
        U = "js-2.7.0";
      async function D(e, t) {
        let s = M({ sdkType: "wcm", sdkVersion: U }, t),
          r = new URL(e, P);
        return (
      ...
      let S = {
        ...
        getWalletImageUrl: (e) =>
          `${P}/w3m/v1/getWalletImage/${e}?projectId=${W.state.projectId}&sdkType=wcm&sdkVersion=${U}`,
        getAssetImageUrl: (e) =>
          `${P}/w3m/v1/getAssetImage/${e}?projectId=${W.state.projectId}&sdkType=wcm&sdkVersion=${U}`,
      };
      ...
      class n {
        ...
        async initUi() {
          if ("undefined" != typeof window) {
            await Promise.all([s.e(75719), s.e(97487)]).then(s.bind(s, 97487));
