...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [34625],
  {
    33154: function (e, t, r) {
      ...
      var p = r(6142),
        y = r(57111);
      n.UN.utils.randomPrivateKey;
      let b = () => {
          let e = n.UN.utils.randomPrivateKey(),
            t = m(e),
            r = new Uint8Array(64);
      ...
      function f(e) {
        try {
          return n.UN.ExtendedPoint.fromHex(e), !0;
        } catch {
          return !1;
        }
      }
      let k = (e, t) => n.UN.sign(e, t.slice(0, 32)),
        I = n.UN.verify,
        x = (e) =>
          i.Buffer.isBuffer(e)
            ? e
            : e instanceof Uint8Array
            ? i.Buffer.from(e.buffer, e.byteOffset, e.byteLength)
            : i.Buffer.from(e);
      class S {
        constructor(e) {
        ...
        encode() {
          return i.Buffer.from((0, l.serialize)(w, this));
        }
        static decode(e) {
      ...
      class _ extends S {
        ...
        static isOnCurve(e) {
          return f(new _(e).toBytes());
        }
      }
      (_.default = new _("11111111111111111111111111111111")),
        w.set(_, { kind: "struct", fields: [["_bn", "u256"]] }),
      ...
      let P = (e = "publicKey") => d.Ik(32, e),
        K = (e = "signature") => d.Ik(64, e),
        z = (e = "string") => {
          let t = d.n_(
              [
                d.Jq("length"),
                d.Jq("lengthPadding"),
                d.Ik(d.cv(d.Jq(), -8), "chars"),
              ],
              e
            ),
            r = t.decode.bind(t),
          ...
          return (
            ...
            (t.encode = (e, t, r) =>
              n({ chars: i.Buffer.from(e, "utf8") }, t, r)),
            (t.alloc = (e) =>
              d.Jq().span + d.Jq().span + i.Buffer.from(e, "utf8").length),
            t
          );
        };
      function T(e) {
        ...
        drainKeysFoundInLookupTable(e, t) {
          ...
          for (let [n, s] of this.keyMetaMap.entries())
            if (t(s)) {
              ...
              s >= 0 &&
                (L(s < 256, "Max lookup table index exceeded"),
                r.push(s),
                i.push(t),
      ...
      let G = "Reached end of buffer unexpectedly";
      function Z(e) {
        if (0 === e.length) throw Error(G);
        return e.shift();
      }
      function O(e, ...t) {
        let [r] = t;
      ...
      class j {
        constructor(e) {
          (this.header = void 0),
            ...
            (this.accountKeys = e.accountKeys.map((e) => new _(e))),
        ...
        getAccountKeys() {
          return new W(this.staticAccountKeys);
        }
        static compile(e) {
          let [t, r] = q
        ...
        serialize() {
          ...
          r.forEach((e) => {
            let t = d
              .n_([
                d.u8("programIdIndex"),
                d.Ik(e.keyIndicesCount.length, "keyIndicesCount"),
                d.A9(d.u8("keyIndex"), e.keyIndices.length, "keyIndices"),
                d.Ik(e.dataLength.length, "dataLength"),
                d.A9(d.u8("userdatum"), e.data.length, "data"),
              ])
              .encode(e, s, a);
            a += t;
          }),
            (s = s.slice(0, a));
          let o = d.n_([
              d.Ik(1, "numRequiredSignatures"),
              d.Ik(1, "numReadonlySignedAccounts"),
              d.Ik(1, "numReadonlyUnsignedAccounts"),
              d.Ik(t.length, "keyCount"),
              d.A9(P("key"), e, "keys"),
              P("recentBlockhash"),
            ]),
            c = {
            ...
            h = o.encode(c, l);
          return s.copy(l, h), l.slice(0, h + s.length);
        }
        static from(e) {
          let t = [...e],
            r = Z(t);
      ...
      class J {
        ...
        getAccountKeys(e) {
          ...
          return new W(this.staticAccountKeys, t);
        }
        isAccountSigner(e) {
          return e < this.header.numRequiredSignatures;
        }
        ...
        static compile(e) {
          let t = q.compile(e.instructions, e.payerKey),
            r = [],
            i = { writable: [], readonly: [] };
          ...
          let [n, s] = t.getMessageComponents(),
            a = new W(s, i).compileInstructions(e.instructions);
          return new J({
            header: n,
            staticAccountKeys: s,
            recentBlockhash: e.recentBlockhash,
        ...
        serialize() {
          let e = [];
          E(e, this.staticAccountKeys.length);
          let t = this.serializeInstructions(),
            r = [];
          E(r, this.compiledInstructions.length);
          let i = this.serializeAddressTableLookups(),
            n = [];
          E(n, this.addressTableLookups.length);
          let s = d.n_([
              d.u8("prefix"),
              d.n_(
                [
              ...
              d.Ik(e.length, "staticAccountKeysLength"),
              d.A9(P(), this.staticAccountKeys.length, "staticAccountKeys"),
              P("recentBlockhash"),
              d.Ik(r.length, "instructionsLength"),
              d.Ik(t.length, "serializedInstructions"),
              d.Ik(n.length, "addressTableLookupsLength"),
              d.Ik(i.length, "serializedAddressTableLookups"),
            ]),
        ...
        serializeInstructions() {
          ...
          for (let r of this.compiledInstructions) {
            let i = [];
            E(i, r.accountKeyIndexes.length);
            let n = [];
            E(n, r.data.length);
            let s = d.n_([
              d.u8("programIdIndex"),
              d.Ik(i.length, "encodedAccountKeyIndexesLength"),
              d.A9(d.u8(), r.accountKeyIndexes.length, "accountKeyIndexes"),
              d.Ik(n.length, "encodedDataLength"),
              d.Ik(r.data.length, "data"),
            ]);
            e += s.encode(
              {
        ...
        serializeAddressTableLookups() {
          ...
          for (let r of this.addressTableLookups) {
            let i = [];
            E(i, r.writableIndexes.length);
            let n = [];
            E(n, r.readonlyIndexes.length);
            let s = d.n_([
              P("accountKey"),
              d.Ik(i.length, "encodedWritableIndexesLength"),
              d.A9(d.u8(), r.writableIndexes.length, "writableIndexes"),
              d.Ik(n.length, "encodedReadonlyIndexesLength"),
              d.A9(d.u8(), r.readonlyIndexes.length, "readonlyIndexes"),
            ]);
            e += s.encode(
              {
        ...
        static deserialize(e) {
          let t = [...e],
            r = Z(t),
            i = 127 & r;
          L(r !== i, "Expected versioned message but received legacy message"),
            L(
              0 === i,
          ...
          let n = {
            ...
            s = [],
            a = T(t);
          for (let e = 0; e < a; e++) s.push(new _(O(t, 0, 32)));
          let o = u().encode(O(t, 0, 32)),
            c = T(t),
            l = [];
          for (let e = 0; e < c; e++) {
            let e = Z(t),
              ...
              i = O(t, 0, r),
              n = T(t),
              s = new Uint8Array(O(t, 0, n));
            l.push({ programIdIndex: e, accountKeyIndexes: i, data: s });
          }
          let d = T(t),
            h = [];
          for (let e = 0; e < d; e++) {
            let e = new _(O(t, 0, 32)),
              r = T(t),
              i = O(t, 0, r),
              n = T(t),
              s = O(t, 0, n);
      ...
      let X = {
          ...
          deserialize: (e) => {
            let t = X.deserializeMessageVersion(e);
            if ("legacy" === t) return j.from(e);
      ...
      class U {
          ...
          return (
            e.forEach((e) => {
              "instructions" in e
                ...
                : this.instructions.push(new C(e));
            }),
            this
          );
        }
        compileMessage() {
          ...
          t.forEach((e) => {
            ...
            i.forEach((e) => {
              n.push({ pubkey: new _(e), isSigner: !1, isWritable: !1 });
            });
          let s = [];
          n.forEach((e) => {
        ...
        _getMessageSignednessErrors(e, t) {
          ...
          for (let { signature: i, publicKey: n } of this.signatures)
            null === i
              ? t && (r.missing ||= []).push(n)
              : I(i, e, n.toBytes()) || (r.invalid ||= []).push(n);
...
Missing signature for public key${
        ...
        _serialize(e) {
          ...
          return (
            L(t.length < 256),
            i.Buffer.from(r).copy(s, 0),
            t.forEach(({ signature: e }, t) => {
              null !== e &&
                (L(64 === e.length, "signature has invalid length"),
                i.Buffer.from(e).copy(s, r.length + 64 * t));
            }),
            e.copy(s, r.length + 64 * t.length),
            L(s.length <= 1232, `Transaction too large: ${s.length} > 1232`),
            s
          );
        }
        get keys() {
        ...
        static from(e) {
          ...
          for (let e = 0; e < r; e++) {
            let e = O(t, 0, 64);
            n.push(u().encode(i.Buffer.from(e)));
          }
          return U.populate(j.from(t), n);
        }
        static populate(e, t = []) {
          let r = new U();
          return (
            ...
            t.forEach((t, i) => {
              let n = {
                signature: t == u().encode(M) ? null : u().decode(t),
      ...
      class N {
        ...
        serialize() {
          let e = this.message.serialize(),
            t = [];
          E(t, this.signatures.length);
          let r = d.n_([
              d.Ik(t.length, "encodedSignaturesLength"),
              d.A9(K(), this.signatures.length, "signatures"),
              d.Ik(e.length, "serializedMessage"),
            ]),
        ...
        static deserialize(e) {
          let t = [...e],
            r = [],
            i = T(t);
          for (let e = 0; e < i; e++) r.push(new Uint8Array(O(t, 0, 64)));
          return new N(X.deserialize(new Uint8Array(t)), r);
        }
        sign(e) {
          ...
          for (let i of e) {
            ...
            L(
              ...
              (this.signatures[e] = k(t, i.secretKey));
          }
        }
        addSignature(e, t) {
      ...
      let $ = new _("SysvarC1ock11111111111111111111111111111111");
      new _("SysvarEpochSchedu1e111111111111111111111111"),
        new _("Sysvar1nstructions1111111111111111111111111");
      let F = new _("SysvarRecentB1ockHashes11111111111111111111"),
        V = new _("SysvarRent111111111111111111111111111111111");
      ...
      let H = new _("SysvarStakeHistory1111111111111111111111111");
...
` +
      ...
      async function Q(e, t, r, i) {
        ...
        if (null != t.recentBlockhash && null != t.lastValidBlockHeight)
          ...
          i?.abortSignal != null &&
            ...
            (n = (await e.confirmTransaction(a, i && i.commitment)).value);
        if (n.err) {
          if (null != a)
            throw new D({
              action: "send",
          ...
          throw Error(`Transaction ${a} failed (${JSON.stringify(n)})`);
        }
        return a;
      }
      function Y(e, t) {
      ...
      let ee = d._O("lamportsPerSignature"),
        et = d.n_([
          d.Jq("version"),
          d.Jq("state"),
          P("authorizedPubkey"),
          P("nonce"),
          d.n_([ee], "feeCalculator"),
        ]).span;
      function er(e) {
        let t = (0, d.Ik)(8, e),
          r = t.decode.bind(t),
        ...
        return (
          ...
          (t.encode = (e, t, r) => i(n.encode(e), t, r)),
          t
        );
      }
      let ei = Object.freeze({
        ...
        Assign: {
          index: 1,
          layout: d.n_([d.Jq("instruction"), P("programId")]),
        },
        Transfer: {
          index: 2,
          layout: d.n_([d.Jq("instruction"), er("lamports")]),
        },
        CreateWithSeed: {
          index: 3,
          layout: d.n_([
        ...
        AdvanceNonceAccount: { index: 4, layout: d.n_([d.Jq("instruction")]) },
        WithdrawNonceAccount: {
          index: 5,
          layout: d.n_([d.Jq("instruction"), d.gM("lamports")]),
        },
        InitializeNonceAccount: {
          index: 6,
          layout: d.n_([d.Jq("instruction"), P("authorized")]),
        },
        ...
        Allocate: {
          index: 8,
          layout: d.n_([d.Jq("instruction"), d.gM("space")]),
        },
        AllocateWithSeed: {
          index: 9,
          layout: d.n_([
        ...
        UpgradeNonceAccount: { index: 12, layout: d.n_([d.Jq("instruction")]) },
      });
      class en {
        constructor() {}
        ...
        static transfer(e) {
          ...
          return (
            "basePubkey" in e
              ...
              : ((t = Y(ei.Transfer, { lamports: BigInt(e.lamports) })),
                (r = [
                  { pubkey: e.fromPubkey, isSigner: !0, isWritable: !0 },
                  { pubkey: e.toPubkey, isSigner: !1, isWritable: !0 },
                ])),
            new C({ keys: r, programId: this.programId, data: t })
          );
        }
        static assign(e) {
          let t, r;
          return (
            "basePubkey" in e
              ...
              : ((t = Y(ei.Assign, { programId: x(e.programId.toBuffer()) })),
                (r = [
        ...
        static nonceInitialize(e) {
          let t = Y(ei.InitializeNonceAccount, {
        ...
        static nonceAdvance(e) {
          let t = Y(ei.AdvanceNonceAccount);
          return new C({
            keys: [
              { pubkey: e.noncePubkey, isSigner: !1, isWritable: !0 },
              { pubkey: F, isSigner: !1, isWritable: !1 },
        ...
        static nonceWithdraw(e) {
          let t = Y(ei.WithdrawNonceAccount, { lamports: e.lamports });
          return new C({
            keys: [
              { pubkey: e.noncePubkey, isSigner: !1, isWritable: !0 },
              { pubkey: e.toPubkey, isSigner: !1, isWritable: !0 },
        ...
        static nonceAuthorize(e) {
          let t = Y(ei.AuthorizeNonceAccount, {
      ...
      en.programId = new _("11111111111111111111111111111111");
      class es {
        constructor() {}
        ...
        static async load(e, t, r, n, s) {
          {
            ...
            if (null !== a) {
              ...
              a.data.length !== s.length &&
                (o = o || new U()).add(
                  en.allocate({ accountPubkey: r.publicKey, space: s.length })
                ),
                a.owner.equals(n) ||
                  (o = o || new U()).add(
                    en.assign({ accountPubkey: r.publicKey, programId: n })
                  ),
                a.lamports < i &&
                  (o = o || new U()).add(
                    en.transfer({
            ...
            null !== o && (await Q(e, o, [t, r], { commitment: "confirmed" }));
          }
          let a = d.n_([
              d.Jq("instruction"),
              d.Jq("offset"),
              d.Jq("bytesLength"),
              d.Jq("bytesLengthPadding"),
              d.A9(d.u8("byte"), d.cv(d.Jq(), -8), "bytes"),
            ]),
            o = es.chunkSize,
            u = 0,
            c = s,
          ...
          for (; c.length > 0; ) {
            ...
            l.push(Q(e, h, [t, r], { commitment: "confirmed" })),
          ...
          await Promise.all(l);
          {
            let s = d.n_([d.Jq("instruction")]),
              a = i.Buffer.alloc(s.span);
            s.encode({ instruction: 1 }, a);
            let o = new U().add({
                keys: [
              ...
              u = "processed",
              c = await e.sendTransaction(o, [t, r], {
      ...
      (es.chunkSize = 932),
        ...
        d.n_([
          d.Jq("typeIndex"),
          er("deactivationSlot"),
          d._O("lastExtendedSlot"),
          d.u8("lastExtendedStartIndex"),
          d.u8(),
          d.A9(P(), d.cv(d.u8(), -1), "authority"),
        ]);
      let ea = (0, g.oQ)((0, g.eE)(_), (0, g.Z_)(), (e) => new _(e)),
        eo = (0, g.bc)([(0, g.Z_)(), (0, g.i0)("base64")]),
        eu = (0, g.oQ)((0, g.eE)(i.Buffer), eo, (e) =>
          i.Buffer.from(e[0], "base64")
        );
      function ec(e) {
        return (0, g.G0)([
          (0, g.dt)({ jsonrpc: (0, g.i0)("2.0"), id: (0, g.Z_)(), result: e }),
          (0, g.dt)({
            jsonrpc: (0, g.i0)("2.0"),
            id: (0, g.Z_)(),
            error: (0, g.dt)({
      ...
      let el = ec((0, g._4)());
      function ed(e) {
        return (0, g.oQ)(ec(e), el, (t) =>
          "error" in t ? t : { ...t, result: (0, g.Ue)(t.result, e) }
        );
      }
      function eh(e) {
        return ed(
          (0, g.dt)({ context: (0, g.dt)({ slot: (0, g.Rx)() }), value: e })
        );
      }
      function eg(e) {
        return (0, g.dt)({
          context: (0, g.dt)({ slot: (0, g.Rx)() }),
          value: e,
        });
      }
      let ep = (0, g.dt)({
      ...
      let ey = (0, g.IX)(
          (0, g.dt)({ slot: (0, g.Rx)(), prioritizationFee: (0, g.Rx)() })
        ),
        eb = (0, g.dt)({
          total: (0, g.Rx)(),
          validator: (0, g.Rx)(),
        ...
        ek = (0, g.IM)((0, g.Z_)(), (0, g.IX)((0, g.Rx)())),
        eI = (0, g.AG)((0, g.G0)([(0, g.dt)({}), (0, g.Z_)()])),
        ex = (0, g.dt)({ err: eI }),
        eS = (0, g.i0)("receivedSignature");
      (0, g.dt)({
        "solana-core": (0, g.Z_)(),
      ...
      eh(
        (0, g.dt)({
          ...
          innerInstructions: (0, g.jt)(
            (0, g.AG)(
              (0, g.IX)(
                (0, g.dt)({
                  index: (0, g.Rx)(),
                  instructions: (0, g.IX)((0, g.G0)([ew, eA])),
                })
              )
            )
          ),
        ...
        eh(
          (0, g.dt)({
            ...
            range: (0, g.dt)({ firstSlot: (0, g.Rx)(), lastSlot: (0, g.Rx)() }),
          })
        ),
        ed(ep),
        ed(eb),
        ...
        eh(
          (0, g.dt)({
            ...
            nonCirculatingAccounts: (0, g.IX)(ea),
          })
        );
      let e_ = (0, g.dt)({
        amount: (0, g.Z_)(),
      ...
      eh(
        ...
        eh((0, g.IX)((0, g.dt)({ lamports: (0, g.Rx)(), address: ea })));
      let ev = (0, g.dt)({
        executable: (0, g.O7)(),
        owner: ea,
        lamports: (0, g.Rx)(),
      ...
      (0, g.dt)({ pubkey: ea, account: ev });
      let eB = (0, g.oQ)(
          (0, g.G0)([(0, g.eE)(i.Buffer), eR]),
          (0, g.G0)([eo, eR]),
          (e) => (Array.isArray(e) ? (0, g.Ue)(e, eu) : e)
        ),
        eW = (0, g.dt)({
          executable: (0, g.O7)(),
          owner: ea,
      ...
      (0, g.dt)({ pubkey: ea, account: eW }),
        ...
        (0, g.dt)({ subscription: (0, g.Rx)(), result: eg(ev) });
      let eP = (0, g.dt)({ pubkey: ea, account: ev });
      (0, g.dt)({ subscription: (0, g.Rx)(), result: eg(eP) });
      let eK = (0, g.dt)({
        parent: (0, g.Rx)(),
        slot: (0, g.Rx)(),
        root: (0, g.Rx)(),
      });
      (0, g.dt)({ subscription: (0, g.Rx)(), result: eK });
      let ez = (0, g.G0)([
        (0, g.dt)({
          type: (0, g.G0)([
            (0, g.i0)("firstShredReceived"),
            (0, g.i0)("completed"),
            (0, g.i0)("optimisticConfirmation"),
            (0, g.i0)("root"),
          ]),
          slot: (0, g.Rx)(),
          timestamp: (0, g.Rx)(),
      ...
      (0, g.dt)({ subscription: (0, g.Rx)(), result: ez }),
        (0, g.dt)({
          subscription: (0, g.Rx)(),
          result: eg((0, g.G0)([ex, eS])),
        }),
        (0, g.dt)({ subscription: (0, g.Rx)(), result: (0, g.Rx)() }),
        (0, g.dt)({
          pubkey: (0, g.Z_)(),
      ...
      let eT = (0, g.dt)({
        ...
        epochCredits: (0, g.IX)(
          (0, g.bc)([(0, g.Rx)(), (0, g.Rx)(), (0, g.Rx)()])
        ),
        commission: (0, g.Rx)(),
        lastVote: (0, g.Rx)(),
        rootSlot: (0, g.AG)((0, g.Rx)()),
      });
      ed((0, g.dt)({ current: (0, g.IX)(eT), delinquent: (0, g.IX)(eT) }));
      let eE = (0, g.G0)([
          (0, g.i0)("processed"),
          (0, g.i0)("confirmed"),
          (0, g.i0)("finalized"),
        ...
        eL = (0, g.dt)({
          ...
          err: eI,
          confirmationStatus: (0, g.jt)(eE),
        });
      eh((0, g.IX)((0, g.AG)(eL))), ed((0, g.Rx)());
      let eq = (0, g.dt)({
          accountKey: ea,
        ...
        eG = (0, g.dt)({
          ...
          message: (0, g.dt)({
            ...
            addressTableLookups: (0, g.jt)((0, g.IX)(eq)),
          }),
        }),
        eZ = (0, g.dt)({
          pubkey: ea,
          ...
          writable: (0, g.O7)(),
          source: (0, g.jt)(
            (0, g.G0)([(0, g.i0)("transaction"), (0, g.i0)("lookupTable")])
          ),
        }),
        eO = (0, g.dt)({
          accountKeys: (0, g.IX)(eZ),
          signatures: (0, g.IX)((0, g.Z_)()),
        }),
        ej = (0, g.dt)({
          parsed: (0, g._4)(),
        ...
        eC = (0, g.oQ)(eX, eM, (e) =>
          "accounts" in e ? (0, g.Ue)(e, eJ) : (0, g.Ue)(e, ej)
        ),
        eU = (0, g.dt)({
          signatures: (0, g.IX)((0, g.Z_)()),
          message: (0, g.dt)({
            ...
            recentBlockhash: (0, g.Z_)(),
            addressTableLookups: (0, g.jt)((0, g.AG)((0, g.IX)(eq))),
          }),
        }),
        eN = (0, g.dt)({
          accountIndex: (0, g.Rx)(),
          mint: (0, g.Z_)(),
          owner: (0, g.jt)((0, g.Z_)()),
          programId: (0, g.jt)((0, g.Z_)()),
          uiTokenAmount: e_,
        }),
        e$ = (0, g.dt)({ writable: (0, g.IX)(ea), readonly: (0, g.IX)(ea) }),
        eF = (0, g.dt)({
          err: eI,
          fee: (0, g.Rx)(),
          innerInstructions: (0, g.jt)(
          ...
          preTokenBalances: (0, g.jt)((0, g.AG)((0, g.IX)(eN))),
          postTokenBalances: (0, g.jt)((0, g.AG)((0, g.IX)(eN))),
          loadedAddresses: (0, g.jt)(e$),
        ...
        eV = (0, g.dt)({
          ...
          innerInstructions: (0, g.jt)(
            (0, g.AG)(
              (0, g.IX)(
                (0, g.dt)({ index: (0, g.Rx)(), instructions: (0, g.IX)(eC) })
              )
            )
          ),
          preBalances: (0, g.IX)((0, g.Rx)()),
        ...
        eH = (0, g.G0)([(0, g.i0)(0), (0, g.i0)("legacy")]),
        eD = (0, g.dt)({
          pubkey: (0, g.Z_)(),
          lamports: (0, g.Rx)(),
        ...
        ed(
          (0, g.AG)(
            (0, g.dt)({
              ...
              parentSlot: (0, g.Rx)(),
              transactions: (0, g.IX)(
                (0, g.dt)({ transaction: eG, meta: (0, g.AG)(eF) })
              ),
              rewards: (0, g.jt)((0, g.IX)(eD)),
              blockTime: (0, g.AG)((0, g.Rx)()),
            })
      ...
      ed((0, g.IX)(eQ)),
        eh(
          (0, g.AG)(
            (0, g.dt)({
              feeCalculator: (0, g.dt)({ lamportsPerSignature: (0, g.Rx)() }),
            })
          )
        ),
        ed((0, g.Z_)()),
      ...
      (0, g.dt)({ result: eg(eY), subscription: (0, g.Rx)() });
      class e0 {
        constructor(e) {
          (this._keypair = void 0), (this._keypair = e ?? b());
        }
        static generate() {
          return new e0(b());
        }
        static fromSecretKey(e, t) {
          ...
          if (!t || !t.skipValidation) {
            let t = m(e.slice(0, 32));
            for (let e = 0; e < 32; e++)
              if (r[e] !== t[e]) throw Error("provided secretKey is invalid");
          }
          return new e0({ publicKey: r, secretKey: e });
        }
        static fromSeed(e) {
          let t = m(e),
            r = new Uint8Array(64);
          return r.set(e), r.set(t, 32), new e0({ publicKey: t, secretKey: r });
        }
        get publicKey() {
      ...
      let e1 = Object.freeze({
        ...
        FreezeLookupTable: { index: 1, layout: d.n_([d.Jq("instruction")]) },
        ExtendLookupTable: {
          index: 2,
          layout: d.n_([
            d.Jq("instruction"),
            er(),
            d.A9(P(), d.cv(d.Jq(), -8), "addresses"),
          ]),
        },
        DeactivateLookupTable: {
          index: 3,
          layout: d.n_([d.Jq("instruction")]),
        },
        CloseLookupTable: { index: 4, layout: d.n_([d.Jq("instruction")]) },
      });
      class e8 {
        constructor() {}
        static createLookupTable(e) {
          let [t, r] = _.findProgramAddressSync(
              [e.authority.toBuffer(), (0, h.bP)().encode(e.recentSlot)],
              this.programId
            ),
            i = Y(e1.CreateLookupTable, {
          ...
          return [new C({ programId: this.programId, keys: n, data: i }), t];
        }
        static freezeLookupTable(e) {
          let t = Y(e1.FreezeLookupTable),
            r = [
              { pubkey: e.lookupTable, isSigner: !1, isWritable: !0 },
              { pubkey: e.authority, isSigner: !0, isWritable: !1 },
            ];
          return new C({ programId: this.programId, keys: r, data: t });
        }
        static extendLookupTable(e) {
          let t = Y(e1.ExtendLookupTable, {
          ...
          return (
            ...
            new C({ programId: this.programId, keys: r, data: t })
          );
        }
        static deactivateLookupTable(e) {
          let t = Y(e1.DeactivateLookupTable),
            r = [
              { pubkey: e.lookupTable, isSigner: !1, isWritable: !0 },
              { pubkey: e.authority, isSigner: !0, isWritable: !1 },
            ];
      ...
      e8.programId = new _("AddressLookupTab1e1111111111111111111111111");
      let e2 = Object.freeze({
        ...
        RequestHeapFrame: {
          index: 1,
          layout: d.n_([d.u8("instruction"), d.Jq("bytes")]),
        },
        SetComputeUnitLimit: {
          index: 2,
          layout: d.n_([d.u8("instruction"), d.Jq("units")]),
        },
        SetComputeUnitPrice: {
          index: 3,
          layout: d.n_([d.u8("instruction"), er("microLamports")]),
        },
      });
      class e3 {
        constructor() {}
        static requestUnits(e) {
          let t = Y(e2.RequestUnits, e);
          return new C({ keys: [], programId: this.programId, data: t });
        }
        static requestHeapFrame(e) {
          let t = Y(e2.RequestHeapFrame, e);
          return new C({ keys: [], programId: this.programId, data: t });
        }
        static setComputeUnitLimit(e) {
          let t = Y(e2.SetComputeUnitLimit, e);
          return new C({ keys: [], programId: this.programId, data: t });
        }
        static setComputeUnitPrice(e) {
          let t = Y(e2.SetComputeUnitPrice, {
            microLamports: BigInt(e.microLamports),
          });
          return new C({ keys: [], programId: this.programId, data: t });
        }
      }
      e3.programId = new _("ComputeBudget111111111111111111111111111111");
      let e4 = d.n_([
        d.u8("numSignatures"),
        d.u8("padding"),
        d.KB("signatureOffset"),
        d.KB("signatureInstructionIndex"),
        d.KB("publicKeyOffset"),
        d.KB("publicKeyInstructionIndex"),
        d.KB("messageDataOffset"),
        d.KB("messageDataSize"),
        d.KB("messageInstructionIndex"),
      ]);
      class e5 {
        constructor() {}
        static createInstructionWithPublicKey(e) {
          ...
          return (
            ...
            c.fill(n, o),
            c.fill(r, u),
            new C({ keys: [], programId: e5.programId, data: c })
          );
        }
      ...
      e5.programId = new _("Ed25519SigVerify111111111111111111111111111");
      let e6 = (e, t) => {
        let r = y.kA.sign(e, t);
        return [r.toCompactRawBytes(), r.recovery];
      };
      y.kA.utils.isValidPrivateKey;
      let e7 = y.kA.getPublicKey,
        e9 = d.n_([
          d.u8("numSignatures"),
          d.KB("signatureOffset"),
          d.u8("signatureInstructionIndex"),
          d.KB("ethAddressOffset"),
      ...
      class te {
        ...
        static publicKeyToEthAddress(e) {
          ...
          try {
            return i.Buffer.from((0, p.fr)(x(e))).slice(-20);
          } catch (e) {
        ...
        static createInstructionWithPublicKey(e) {
          ...
          return te.createInstructionWithEthAddress({
            ethAddress: te.publicKeyToEthAddress(t),
            message: r,
            signature: i,
            recoveryId: n,
            instructionIndex: s,
        ...
        static createInstructionWithEthAddress(e) {
          ...
          let u = 12 + t.length,
            c = u + s.length + 1,
            l = i.Buffer.alloc(e9.span + n.length);
          return (
            e9.encode(
              {
                numSignatures: 1,
            ...
            l.fill(x(n), e9.span),
            new C({ keys: [], programId: te.programId, data: l })
          );
        }
        static createInstructionWithPrivateKey(e) {
      ...
      te.programId = new _("KeccakSecp256k11111111111111111111111111111");
      let tt = new _("StakeConfig11111111111111111111111111111111");
      class tr {
        constructor(e, t, r) {
      ...
      tr.default = new tr(0, 0, _.default);
      let ti = Object.freeze({
        Initialize: {
          index: 0,
          layout: d.n_([
            d.Jq("instruction"),
            ((e = "authorized") => d.n_([P("staker"), P("withdrawer")], e))(),
            ((e = "lockup") =>
              d.n_(
                [d.gM("unixTimestamp"), d.gM("epoch"), P("custodian")],
                e
              ))(),
          ]),
        },
        Authorize: {
          ...
          layout: d.n_([
            d.Jq("instruction"),
            P("newAuthorized"),
            d.Jq("stakeAuthorizationType"),
          ]),
        },
        Delegate: { index: 2, layout: d.n_([d.Jq("instruction")]) },
        Split: {
          index: 3,
          layout: d.n_([d.Jq("instruction"), d.gM("lamports")]),
        },
        ...
        Deactivate: { index: 5, layout: d.n_([d.Jq("instruction")]) },
        Merge: { index: 7, layout: d.n_([d.Jq("instruction")]) },
        AuthorizeWithSeed: {
          index: 8,
          layout: d.n_([
            d.Jq("instruction"),
      ...
      class tn {
          ...
          let { stakePubkey: t, authorized: r, lockup: i } = e,
            ...
            s = Y(ti.Initialize, {
              ...
              lockup: {
                ...
                epoch: n.epoch,
                custodian: x(n.custodian.toBuffer()),
              },
            });
          return new C({
            keys: [
        ...
        static delegate(e) {
          ...
          return new U().add({
            keys: [
              ...
              { pubkey: tt, isSigner: !1, isWritable: !1 },
        ...
        static authorize(e) {
          let {
            ...
            o = [
              { pubkey: t, isSigner: !1, isWritable: !0 },
              { pubkey: $, isSigner: !1, isWritable: !0 },
              { pubkey: r, isSigner: !0, isWritable: !1 },
            ];
          return (
            s && o.push({ pubkey: s, isSigner: !0, isWritable: !1 }),
            new U().add({ keys: o, programId: this.programId, data: a })
          );
        }
        static authorizeWithSeed(e) {
          ...
          return (
            ...
            new U().add({ keys: c, programId: this.programId, data: u })
          );
        }
      ...
      (tn.programId = new _("Stake11111111111111111111111111111111111111")),
        (tn.space = 200);
          ...
          layout: d.n_([
            ...
            ((e = "voteAuthorizeWithSeedArgs") =>
              d.n_(
                [
                  d.Jq("voteAuthorizationType"),
                  P("currentAuthorityDerivedKeyOwnerPubkey"),
      ...
      class ta {
        ...
        static updateValidatorIdentity(e) {
          let {
            ...
            n = Y(ts.UpdateValidatorIdentity);
          return new U().add({
            keys: [
              { pubkey: t, isSigner: !1, isWritable: !0 },
              { pubkey: i, isSigner: !0, isWritable: !1 },
      ...
      (ta.programId = new _("Vote111111111111111111111111111111111111111")),
        (ta.space = 3762),
        ...
        d.n_([
          ...
          d._O(),
          d.A9(
            d.n_([d._O("slot"), d.Jq("confirmationCount")]),
            d.cv(d.Jq(), -8),
            "votes"
          ),
          d.u8("rootSlotValid"),
          ...
          d._O(),
          d.A9(
            d.n_([d._O("epoch"), P("authorizedVoter")]),
            d.cv(d.Jq(), -8),
            "authorizedVoters"
          ),
          d.n_(
            [
              d.A9(
                d.n_([
                  P("authorizedPubkey"),
                  d._O("epochOfLastAuthorizedSwitch"),
                  d._O("targetEpoch"),
                ]),
                32,
                "buf"
          ...
          d._O(),
          d.A9(
            d.n_([d._O("epoch"), d._O("credits"), d._O("prevCredits")]),
            d.cv(d.Jq(), -8),
            "epochCredits"
          ),
          d.n_([d._O("slot"), d._O("timestamp")], "lastTimestamp"),
        ]);
    },
  },
]);
